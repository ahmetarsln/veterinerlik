...
{
    public class EfCurrencyUnitDal : EfEntityRepositoryBase<CurrencyUnit>, ICurrencyUnitDal
    {
        private VpoDbContext _vpoDbContext;
        public EfCurrencyUnitDal(VpoDbContext vpoDbContext) : base(vpoDbContext)
        {
