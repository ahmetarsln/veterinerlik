...
{
    public class EfMeasurementUnitDal : EfEntityRepositoryBase<MeasurementUnit>, IMeasurementUnitDal
    {
        private VpoDbContext _vpoDbContext;
        public EfMeasurementUnitDal(VpoDbContext vpoDbContext) : base(vpoDbContext)
        {
